...
Timer			= {
	...
	__props		= {
		id			= {
				get	= function(t) return GetHandleId(t.obj) end
		},
		remaining	= {
				get = function(t) return TimerGetRemaining(t.obj) end
		},
		timeout		= {
				get = function(t) return TimerGetTimeout(t.obj) end
		},
		elapsed		= {
				get = function(t) return TimerGetElapsed(t.obj) end
		}
	}
}
...
function Timer:resume()	ResumeTimer(self.obj) end
function Timer:start(dur, looped, func)	TimerStart(self.obj, dur, looped, func) end
function Timer:pause() PauseTimer(self.obj) end

function Timer:destroy() DestroyTimer(self.obj) self:unwrap() end
